...
export default function SignalementsAdminPage() {
  ...
  const chargerSignalements = useCallback(async () => {
    try {
      ...
      const resultat =
        await obtenirSignalementsAdmin(
          filtreStatut === "ALL"
            ? undefined
            : filtreStatut
        );
  ...
  async function changerStatutSignalement(
    ...
    try {
      setSignalementEnModification(
        signalement.id
      );
      setErreur("");

      const resultat =
        await modifierStatutSignalementAdmin(
          signalement.id,
          statut
        );
      ...
      ">
        ...
        <div>
          ...
          <p className="
            ...
            text-zinc-500
          ">
            Consultez les signalements envoyés par les
            utilisateurs et assurez leur modération.
          </p>
        ...
        <button
          ...
          disabled={
            chargement ||
            signalementEnModification !== null
          }
          className="
            inline-flex
            items-center
      ...
      <Card className="p-4">
        ...
        {(recherche ||
          ...
          <p className="mt-3 text-xs text-zinc-400">
            {signalementsFiltres.length} résultat
            {signalementsFiltres.length > 1
              ? "s"
              : ""}{" "}
            affiché
            {signalementsFiltres.length > 1
        ...
        <Card className="p-12">
          ...
          ">
            ...
            <p className="
              ...
              text-zinc-400
            ">
              Récupération des signalements depuis le serveur.
            </p>
