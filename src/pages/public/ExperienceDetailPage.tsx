  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6">
      ...
      <Card className="p-6 sm:p-8">
        ...
        <p className="mt-4 whitespace-pre-wrap text-sm leading-7 text-zinc-600 sm:text-base">
          {experience.probleme}
        </p>
      </Card>
      ...
      <Card className="border-zinc-900 bg-zinc-950 p-6 text-white sm:p-8">
      ...
      <section>
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Échangez avec la communauté autour de
            cette expérience technique.
          </p>
        </div>
