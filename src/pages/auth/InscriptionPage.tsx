...
export default function InscriptionPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const { utilisateur, tokenVerification } = response.data;

      if (!utilisateur || !tokenVerification) {
        setErreur("La réponse du serveur est invalide.");
        return;
      }
      ...
      navigate(
        `/verification-email?token=${encodeURIComponent(tokenVerification)}`,
        { replace: true }
      );
    } catch (error: unknown) {
      ...
      <div className="grid min-h-screen lg:grid-cols-2">
          ...
          <div className="relative flex w-full flex-col justify-between p-12 xl:p-16">
            ...
            >
              ...
              <p className="mt-6 max-w-lg text-base leading-7 text-blue-200">
                Rejoignez la communauté de développeurs, améliorez vos compétences et résolvez des problèmes techniques avec CodeDoctor.
              </p>
            </motion.div>
        ...
        <section className="flex items-center justify-center px-5 py-12 sm:px-8">
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-blue-600">Nouveau ici ?</p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div>
                <label htmlFor="nom" className="mb-2 block text-sm font-medium text-zinc-800">
                  Nom complet
                </label>
              ...
              <div>
                <label htmlFor="motDePasse" className="mb-2 block text-sm font-medium text-zinc-800">
                  Mot de passe
                </label>
              ...
              <div className="rounded-xl border border-blue-100 bg-blue-50/60 px-4 py-3">
                <p className="text-xs leading-5 text-blue-700">
                  Vous pourrez configurer une phrase secrète de récupération plus tard, depuis votre profil, pour sécuriser davantage votre compte.
                </p>
              </div>
            ...
            <p className="mt-8 text-center text-xs leading-5 text-zinc-400">
              En créant un compte, vous acceptez les conditions d'utilisation de CodeDoctor.
            </p>
