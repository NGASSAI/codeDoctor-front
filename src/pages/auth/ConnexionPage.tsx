      ...
      <div className="grid min-h-screen lg:grid-cols-2">
        ...
        <section className="relative hidden overflow-hidden bg-zinc-950 lg:flex">
          <div className="absolute inset-0">
            ...
            <div className="absolute -bottom-40 -right-20 h-30rem w-30rem rounded-full bg-white/5 blur-3xl" />
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            >
              ...
              <button
                type="submit"
                disabled={chargement}
                className="group flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-zinc-950 text-sm font-semibold text-white shadow-sm transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {chargement ? (
                  <>
                    <Loader2
